...
```{r RegressionEstimatorsAmazoniaTwoPhase, echo=FALSE, fig.cap="Approximated sampling distribution of the simple regression estimator of the mean AGB (10$\\textsuperscript{9}$ kg ha$\\textsuperscript{-1}$) in Eastern Amazonia in the case that the covariate is observed for all sampling units (One-phase) and for a subsample only (Two-phase)."}
