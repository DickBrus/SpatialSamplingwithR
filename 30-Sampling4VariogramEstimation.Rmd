...
plot(myStrata) +
  geom_point(data = myscsamples, mapping = aes(x = x, y = y), shape = 1, size = 1.3) +
...
plot(myStrata) +
    geom_point(data = mySCsample, mapping = aes(x = x, y = y), shape = 1, size = 2) +
    geom_point(data = mysupsample, mapping = aes(x = x, y = y), shape = 3, size = 2, colour = "red")
#dev.off()
```
