...
```{r histogramsvariogramparameters, echo=FALSE, out.width='100%', fig.asp=0.6, fig.cap="Sampling distribution of the estimators of the parameters of a spherical semivariogram with nugget of compound topographic index in Hunter Valley.", }
...
Finally, the partial derivatives of the kriging variance are used to approximate VKV at the 101 evaluation points. For this the variances and covariances of the estimated semivariogram parameters are needed, estimated by the inverse of the Fisher information matrix (`invI`), see Equation \@ref(eq:varkrigingvar). Matrix `invI` computed in the previous Section \@ref(UncertainSemivariogramParameters) for the simple random sample of 100 points is also used here.
...
```{r HistogramShortestDistance, echo=FALSE, out.width='100%', fig.asp=0.5, fig.cap="Shortest distance of supplemental sample, optimised with mean augmented kriging variance (MAKV) and mean estimation adjusted criterion (MEAC), to spatial coverage sample."}
