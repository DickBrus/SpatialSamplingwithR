...
plot(myStrata) +
  geom_point(data = myscsamples, mapping = aes(x = x, y = y), shape = 1, size = 1.2) +
  geom_point(data = mysupsamples, mapping = aes(x = x, y = y), size = 1.2, colour = "red") +
  coord_fixed() +
  facet_wrap(~ criterion)
```
...
plot(myStrata) +
    geom_point(data = mySCsample, mapping = aes(x = x, y = y), shape = 1, size = 1.2) +
    geom_point(data = mysupsample, mapping = aes(x = x, y = y), size = 1.2, colour = "red")
#dev.off()
```
