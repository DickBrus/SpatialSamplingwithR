...
knitr::kable(
  ...
  kable_classic() %>%
add_footnote("Freq: required sample size computed with the frequentist approach; ALC: average length criterion; ACC: average coverage criterion; WOC: worst outcome criterion.", notation="alphabet")
```
