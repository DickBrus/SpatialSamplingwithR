...
#save(df,file = "../results/MBGridSpacing_Amhara_Sensitivity.RData")
...
res2 <- getGridTopology(grdAmhara) %>% data.frame(.)
#compute total area in km2
A <- length(grdAmhara) * res2$cellsize[1] * res2$cellsize[2]
