...
n_h <- round(n * w_h)
sum(n_h)
# too many pojnts, reduce sample size of merged stratum SA
n_h[2] <- n_h[2]-1
...
print(v_mz_4strata_true <- sum(w_h^2*(1-n_h/N_h)*S2z_h_pop/n_h))
...
print(v_mz_5strata_true <- sum(w_h^2*(1-n_h/N_h)*S2z_h_pop/n_h))
