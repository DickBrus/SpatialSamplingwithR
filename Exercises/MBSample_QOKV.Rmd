...
The parameters of an exponential semivariogram for lnECe are specified.
...
```{r}
grdCRF <- readRDS("../results/CottonResearchFarm_Uzbekistan.rds")
mysample_eval <- grdCRF[, c("x1", "x2")]
