# Version of nested sampling in which in each stage one point is selected 
...
#Define function for random selection of point at some chosen distance from starting point
...
#overlay with the grid and add the fourth attribute (cti) to the data frame
