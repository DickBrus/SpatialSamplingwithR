...
Load the data on soil organic matter concentration in west-Amhara (Ethiopia). Also load the discretisation grid of the study area. Change the projected coordinates from m into km.
...
#save(result, file = "../results/MBGridSpacing_Amhara_QOKV.RData")
