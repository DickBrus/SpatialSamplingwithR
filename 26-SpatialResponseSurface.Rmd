...
saveRDS(grdCRF, file = "data/CottonResearchFarm_Uzbekistan.rds")
```
...
<!--The annealing functions for spatial response surface sampling are defined in **R** script
...
set.seed(314)
mySRSsample <- anneal(
  mysample0 = mysample0, candidates = candi_all, dpnt = ccd_df,
