...
#convert dat to SpatialPointsDataFrame of package sp
...
The means of the two principal component scores are 0, their standard deviations are `r formatC(pc$sdev[1], 3, format = "f")` and `r formatC(pc$sdev[2], 3, format = "f")`. The principal component scores are then scaled so that their standard deviations become 1. They then will have the same weight in the following steps. 
