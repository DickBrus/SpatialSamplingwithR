...
```{block2, type='rmdnote'}
In sampling with replacement the number of unique populations units in the sample can be smaller than the sample size. In this case the sample size refers to the number of draws.
```
