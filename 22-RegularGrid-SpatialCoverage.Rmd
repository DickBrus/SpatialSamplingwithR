...
Grids can be selected with function `spsample` of package **sp** [@Pebesma2005]. Argument `offset` is used to select non-randomly a grid. A sample size can be specified, using argument `n`; alternatively, a grid spacing can be specified using argument `cellsize`.
...
```{r spatialinfillEthiopia, fig.cap="Spatial infill sample of 100 points from the three woredas in Ethiopia."}
