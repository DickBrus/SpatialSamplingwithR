...
```{r HistogramTolerableSpacing, echo = FALSE, fig.width = 5, fig.asp = 0.7, fig.cap = "Histogram of tolerable grid spacings for a target MKV of 0.8."}
...
```{r ProportionMCMCSamples, echo = FALSE, fig.width = 5, fig.asp = 0.7, fig.cap = "Proportion of MCMC sample units with a MKV smaller than or equal to a target MKV of 0.8."}
