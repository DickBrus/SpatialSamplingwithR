...
```{r cLHSscat, echo=FALSE, fig.cap="Conditioned Latin hypercube sample plotted in a scatter plot of SWIR2 against precipitation in the dryest month. The horizontal and the vertical lines are at the breaks of the marginal strata of the covariates SWIR2 and precipitation dryest month, respectively."}
...
Package **clhs** can also be used for selecting a conditioned Latin hypercube sample in addition to existing sampling units, as in spatial infill sampling (Section \@ref(SpatialCoverage)). For this argument `include` can be used. Argument `size` must then be set to the total sample size, i.e. the number of mandatory units plus the number of additional infill units.
