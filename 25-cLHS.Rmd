...
Figure \@ref(fig:cLHS) shows the selected sample in a map of SWIR2. Figure \@ref(fig:cLHSscat) shows the sample plotted in a scatter plot of Precipitation Dryest Month against SWIR2. Each black dot represents one grid cell in the population. The horizontal and vertical lines in this scatter plot are at the breaks of the marginal strata of SWIR2 and Precipitation Dryest Month, respectively. The number of black dots in between two consecutive vertical lines and in between two consecutive horizontal lines is constant (i.e. marginal strata have equal size). The intervals therefore are the narrowest where the density of black dots in the plot is highest. Ideally, in each column and each row there is exactly one sampling unit.
...
```{r cLHSscat, echo=FALSE, fig.cap="Conditioned Latin hypercube sample plotted in a scatter plot of SWIR2 against precipitation in the dryest month. The horizontal and vertical lines are at the breaks of the marginal strata of the covariates SWIR2 and precipitation dryest month, respectively."}
