...
(ref:histVoorstlabel) Histogram of the simulated SOM concentration  (g kg^-1^) in Voorst.

```{r histogramVoorst, echo=FALSE, fig.asp=0.7, fig.cap="(ref:histVoorstlabel)"}
ggplot(grdVoorst) +
