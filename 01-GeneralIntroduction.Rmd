...
```{r histogramPoppyarea, echo = FALSE, fig.width = 5, fig.asp = 0.7, fig.cap = "Histogram of simulated poppy area in ha  per 5 km square in Kandahar."}
ggplot(grdKandahar) +
