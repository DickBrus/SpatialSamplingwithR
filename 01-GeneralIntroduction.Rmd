...
Field <- readOGR(dsn="data", layer="Melle", verbose=FALSE)
...
grd <- readRDS("data/grdVoorst.rds")
ggplot(data=grd) +
...
<!-- Projection attributes: "+proj=sinu +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs +ellps=WGS84 +towgs84=0,0,0"
-->
...
df_lf <- grdSpainPortugal %>% pivot_longer(cols=c("TAS2004","TAS2009","TAS2014","TAS2019"))
ggplot(df_lf) +
