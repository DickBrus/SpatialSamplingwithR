...
1. Write an **R** script to select a covariate space coverage sample of size 20 from Hunter Valley. The data are in `data/grdHunterValley.rds`. Use the covariates cti (compound topographic index, which is the same as topographic wetness index), ndvi (normalised difference vegetation index), and elevation_m in k-means clustering of the raster cells. Plot the clusters and the sample on a map of cti and in a biplot of cti against ndvi.  
