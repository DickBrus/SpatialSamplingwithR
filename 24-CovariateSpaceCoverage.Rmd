...
```{r CSCsample, echo=FALSE, out.width="100%", fig.cap="Covariate space coverage sample of twenty units from Eastern Amazonia, obtained with $k$-means using five covariates in clustering. The map shows the spatial distribution of the twenty clusters."}
ggplot(gridAmazonia) +
...
```{r CSCsampleinscatter, echo=FALSE, out.width='100%', fig.asp=0.5, fig.cap="Covariate space coverage sample, obtained with $k$-means, plotted in scatter plots of pairs of covariates, coloured by cluster."}
...
2. For each unsampled unit $j$, compute $d_{kj}$, the distance in standardised covariate-space between $j$ and the nearest unit $k$ that has already been selected.  
...
```{r CSCIS, echo=FALSE, out.width="100%", fig.cap="Covariate space infill sample from Eastern Amazonia, obtained with modified $k$-means, plotted on a map of SWIR2. The dots represent the fixed centres (legacy sample, five units), the triangles the infill sample (fifteen units)."}
...
```{r CSInfillsampleinscatter, echo=FALSE, out.width='100%', fig.asp=0.5, fig.cap="Covariate space infill sample, obtained with modified $k$-means, plotted in scatter plots of pairs of covariates. The dots represent the fixed centres (legacy sample), the triangles the infill sample."}
units <- sample(nrow(gridAmazonia), size=10000, replace=FALSE)
grd <- gridAmazonia[units,]
...
rownames(df) <- NULL
knitr::kable(
  df, caption = 'Mean RMSE of random forest predictions of aboveground biomass in Eastern Amazonia of 500 covariate space coverage (CSC) samples and 500 simple random (SI) samples, for three sample sizes.',
  booktabs = TRUE,
