...
1. Write an **R** script to select a covariate space coverage (CSC) sample of size 20 from Hunter Valley. The data are in `data/HunterValley.RData`. Use the covariates cti (compound topographic index) and ndvi (normalized difference vegetation index) in $k$-means clustering of the grid cells. Plot the clusters and the sample in a scatter diagram of cti against ndvi.  
