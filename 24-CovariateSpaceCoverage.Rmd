...
(ref:CSCISlabel) Covariate space infill sample from Eastern Amazonia, obtained with modified *k*-means clustering, plotted on a map of SWIR2. The dots represent the fixed centres (legacy sample, five units), the triangles the infill sample (fifteen units).
...
(ref:CSInfillsampleinscatterlabel) Covariate space infill sample, obtained with modified *k*-means clustering, plotted in scatter plots of pairs of covariates. The dots represent the fixed centres (legacy sample), the triangles the infill sample.
