...
# df <- data.frame(RMSE = c(RMSE.SI, RMSE.CSC, RMSE.CLH), Design = rep(c("SI", "CSC", "cLH"), each = 500))
# pdf("Boxplots_RMSE_25.pdf", width=9,height=7)
# print(ggplot(data = df) +
#     geom_boxplot(mapping = aes(y = RMSE, x = Design)) +
...
# df <- data.frame(RMSE = c(RMSE.SI, RMSE.CSC, RMSE.CLH), Design = rep(c("SI", "CSC", "cLH"), each = 500))
# pdf("Boxplots_RMSE_50.pdf", width=9,height=7)
# print(ggplot(data = df) +
#     geom_boxplot(mapping = aes(y = RMSE, x = Design)) +
#     scale_x_discrete(name = "Sampling design") +
#     scale_y_continuous(name = "RMSE"))
...
# df <- data.frame(RMSE = c(RMSE.SI, RMSE.CSC, RMSE.CLH), Design = rep(c("SI", "CSC", "cLH"), each = 500))
# pdf("Boxplots_RMSE_100.pdf", width=9,height=7)
# print(ggplot(data = df) +
#     geom_boxplot(mapping = aes(y = RMSE, x = Design)) +
#     scale_x_discrete(name = "Sampling design") +
#     scale_y_continuous(name = "RMSE"))
