...
Of course, this simple example would only be applicable if we have evidence of a linear relation between study variable $z$ and covariate $x$, and besides if we are willing to rely on the assumption that the residuals are not spatially correlated.  
...
```{r Sample4MappingandEstimationAmazonia2, echo=FALSE, out.width='100%', fig.asp=0.5, fig.cap="Balanced stratified sample with geographical spreading, balanced on lnSWIR2 and the stratum sample sizes (biomes used as strata), Eastern Amazonia."}
