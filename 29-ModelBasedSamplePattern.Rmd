...
The mean kriging variance of the optimised sample equals `r as.character(round(MKV_KED_opt,3))`. This is considerably smaller than the mean kriging variance obtained when the model-based infill sample for OK (Figure \@ref(fig:ModelBasedInfill)) is used in kriging with an external drift: `r as.character(round(MKV_KED_OKsample,3))`.
