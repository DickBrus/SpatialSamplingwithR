...
```{r ModelBasedSampleOK, echo=FALSE, out.width='100%', fig.cap="Sampling pattern optimised for the mean variance of ordinary kriging predictions of lnECe (Model-based sample) and spatial coverage sample (SCS) from the Cotton Research Farm."}
library(spcosa)
