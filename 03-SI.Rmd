...
(ref:SamplingDistributionSIlabel) Approximated sampling distribution of the estimator of the mean SOM concentration (g kg^-1^) in Voorst for simple random sampling of size 40.
