...
with $d$ the number of drop outs and $N^*$ the supposed population size (the number of units in the sampling frame used to select the sample). This yields for the inclusion probability
