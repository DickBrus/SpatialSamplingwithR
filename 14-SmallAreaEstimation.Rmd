...
The alternative is to save the selected units (the sample) in a data frame, passed to argument `data`. The results are identical because the true means of the covariate $x$ passed to argument `exhaustive` contains all required information at the population level.
