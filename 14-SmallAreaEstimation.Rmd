...
knitr::kable(
  res, caption = 'Standard deviations of repeated Horvitz-Thompson (HT) and ratio estimates (ratio) of mean aboveground biomass (AGB) of ecoregions, with simple random sampling without replacement of size 200 from Eastern Amazonia.',
...
```{r RatioversusRegrEcoregions, echo=FALSE, fig.cap="Scatter plot of ratio and regression estimates of mean aboveground biomass (AGB) of ecoregions for simple random sample of size 200 from Eastern Amazonia. In the regression estimate lnSWIR2 is used as a predictor. The line is fitted by ordinary least squares."}
mysample$N <- nrow(gridAmazonia)
design_si <- svydesign(id=~1, data=mysample, fpc=~N)
res <- svyby(~AGB, by=~Ecoregion, design=design_si, FUN=svymean)
...
rownames(df) <- NULL
knitr::kable(
  df, caption = 'Estimated gain in precision of estimated mean of AGB of ecoregions in Eastern Amazonia, as quantified by the estimated variance of the ratio estimator (no covariate used) divided by the estimated variance of the regression estimator (using lnSWIR2 as a predictor), for simple random sampling without replacement of size 200.',
  booktabs = TRUE,
...
knitr::kable(
  df, caption = 'Synthetic estimates of mean aboveground biomass (AGB) of ecoregions for simple random sample without replacement of size 200 from Eastern amazonia, using lnSWIR2 as a predictor. In the final column the number of sampling units per ecoregion is listed.',
...
rownames(df) <- NULL
knitr::kable(
  df, caption = 'Estimated standard error (se), bias, and root mean squared error (RMSE) of the regression estimator (reg) and synthetic estimator (syn). The regression estimator is design-unbiased, so the RMSE of the regression estimator is equal to its standard error.',
  booktabs = TRUE,
...
knitr::kable(
  df, caption = 'Model-based predictions of mean aboveground biomass (AGB) of ecoregions for simple random sample without replacement of size 200 from Eastern Amazonia, obtained with random intercept model and lnSWIR2 as a predictor. se.1 and se.2: standard errors, see text.',
  booktabs = TRUE,
...
rownames(df) <- NULL
knitr::kable(
  df, caption = 'Model-based predictions of mean aboveground biomass (AGB) of ecoregions using a simple random sample without replacement of size from Eastern Amazonia, obtained with geostatistical model and lnSWIR2 as a predictor for the mean. se: standard error of predicted mean.',
  booktabs = TRUE,
...
```{r MBvsSynt, echo=FALSE, fig.cap="Scatter plot of model-based prediction and synthetic estimate of the mean AGB of ecoregions in Eastern Amazonia. The solid line is the 1:1 line."}
...
```{r MBvsMB, echo=FALSE, fig.cap="Scatter plot of model-based predictions of the mean AGB of ecoregions in Eastern Amazonia, obtained with the random intercept model and the geostatistical model. The solid lines is the 1:1 line."}
res <- eblup.mse.f.wrap(domain.data=df_eco, lme.obj=lmm_AGB)
...
```{r MBvsMBse, echo=FALSE,  fig.cap="Scatter plot of standard error of model-based predictions of the mean AGB of ecoregions obtained with the random intercept model and the geostatistical model, using a simple random sample without replacement of size 200 from Eastern Amazonia. The numbers refer to the number of sampling units in an ecoregion. The solid line is the 1:1 line."}
ggplot(data=df) +
