...
knitr::kable(
  ...
  kable_classic() %>%
   add_footnote("The estimated standard errors of 0.0 are non-availables.", notation="alphabet")
```
...
knitr::kable(
  ...
  kable_classic() %>%
   add_footnote("n: expected sample size.", notation="alphabet")
```
...
knitr::kable(
  ...
  kable_classic() %>%
   add_footnote(" For explanation of variances of regression estimator, see text. n2G: sample size of ecoregion; NA: not available; NaN: not a number.", notation="alphabet")
```
...
knitr::kable(
  ...
  kable_classic()  %>%
   add_footnote(" n2G: sample size of ecoregion.", notation="alphabet")
```
...
knitr::kable(
  ...
  kable_classic() %>%
   add_footnote(" se.1 and se.2 are standard errors, for explanation see text.", notation="alphabet")
```
...
knitr::kable(
  ...
  kable_classic() %>%
   add_footnote(" se: standard error of predicted mean.", notation="alphabet")
```
