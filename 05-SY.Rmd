...
Function `spsample` does not work properly in combination with argument `type="hexagonal"`. Over repeated sampling the average sample size is not equal to the chosen sample size passed to argument `n`. The same problem remains when using argument `cellsize`.
