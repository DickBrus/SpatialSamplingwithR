...
Before using this function the data frame with the sample data must be extended with two variables: an index $i$ for the column number and an index $j$ for the row number of the square grid. This is done with function `mutate` of the **dplyr** package [@dplyr].
