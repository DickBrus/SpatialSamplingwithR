...
Using the systematic random sample of Figure \@ref(fig:sampleSY) the $\pi$ estimated population mean equals `r round(mz_HT,3)` g kg^-1^, the ratio estimate equals `r round(mz_ratio,3)` g kg^-1^. The ratio estimate is larger than the $\pi$ estimate because the size of the selected sample is two units smaller (38) than the expected sample size (40).
