...
```{r SamplingDistributionSY,  echo=FALSE, fig.asp=.8, fig.cap="(ref:SamplingDistributionSYlabel)"}
load(file="results/SYVoorst_square.RData")
...
The mean of the 10,000 ratio estimates is 7.810, which is about equal to the population mean `r round(mean(grdVoorst$z),3)`, showing that in this case the design-bias of the ratio estimator is negligibly small indeed.
...
```{r SamplingDistributionApproxVarSY,  echo=FALSE, fig.asp=.8, fig.cap="(ref:SamplingDistributionApproxVarSYlabel)"}
