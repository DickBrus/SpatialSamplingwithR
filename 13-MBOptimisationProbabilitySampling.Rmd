...
```{r, echo = FALSE}
sampleLeest <- read.csv("data/Sample_Leest.csv")
```
...
ggplot(data = vg) +
  ...
  scale_y_continuous(name = "Semivariance", limits = c(0, 1200))
```
...
```{r, echo = FALSE}
sampleMelle <- read.csv("data/Sample_Melle.csv", header = TRUE)
```
...
```{r, echo = FALSE}
sampleXuancheng <- read.csv("data/Sample_Xuancheng.csv")
```
