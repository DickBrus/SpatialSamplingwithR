...
```{r, echo = FALSE, eval = evalFT}
saveRDS(res, file = "results/BootstrapVarianceRegressionTreeAGB_Amazonia.rds")
```

```{r, echo = FALSE}
res <- readRDS(file = "results/BootstrapVarianceRegressionTreeAGB_Amazonia.rds")
```
