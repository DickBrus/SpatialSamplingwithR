...
```{r validatedmaps, echo=FALSE, out.width="100%", fig.cap="Map of the SOM concentration (g kg$\\textsuperscript{-1}$) in the topsoil of Xuancheng, obtained by kriging with an external drift (KED) and random forest (RF)."}
load(file="data/Xuancheng.RData")
