...
```{r Twokrigingsimulations, echo=FALSE, out.width='100%', fig.cap="Two maps simulated with the spherical semivariogram shown above, centred square grid of sampling units, and prediction unit (red cell with coordinates (590,670))."}
...
```{r SimulatedXandZ, echo=FALSE, out.width='100%', fig.cap="Maps with simulated values of covariate $x$ and study variable $z$, centred square grid of sampling units, and prediction unit (red cell with coordinates (590,670))."}
...
with  $\mathbf{I}$ the $n \times n$ identity matrix (matrix with ones on the diagonal, zeroes in all off-diagonal elements). The natural logarithm of the residual likelihood can be computed by [@lar06]
